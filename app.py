...
with aba1:
    st.subheader("OPERALAB - Avaliação de Resultados")
...
with aba2:
    ...
    if df_in is None:
        ...
        # Se a opção for CONAMA 357 classes, mostrar seleção de classe e ambiente
        if spec_key.startswith("CONAMA 357/2005 – Classe") or spec_key == "CONAMA 357/2005 – Classes (selecionar)":
